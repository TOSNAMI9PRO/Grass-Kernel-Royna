...
def main():
    ...
    if not args.target in ['a51', 'm21', 'm31', 'm31s', 'f41', 'm30s', 'gta4xl']:
        print("Please specify a valid target: a51/m21/m31/m31s/f41/m30s/gta4xl")
        return
    ...
    make_defconfig = []
    make_common = ['make', 'O=out', 'LLVM=1', "KCFLAGS=-Wno-implicit-function-declaration -Wno-c23-extensions -Wno-misleading-indentation", f'-j{os.cpu_count()}']
